...
function drawHUD() {
  ...
  colInL.forEach((s, i) => drawSlot(s, colInLx, cy0 - sw + i * sw));       // оръжие + скок (до колбата)
  colOutL.forEach((s, i) => drawSlot(s, colOutLx, cy0 - sw + i * sw));     // двете отвари (навън)
  colInR.forEach((s, i) => drawSlot(s, colInRx, cy0 - 36 * S + i * sw));   // трите магии (до колбата)
  colOutR.forEach((s, i) => drawSlot(s, colOutRx, cy0 - sw + i * sw));     // двете аури (навън)
